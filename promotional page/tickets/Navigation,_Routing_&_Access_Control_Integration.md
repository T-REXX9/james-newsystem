...
**Included:**
- Add "Product Promotions" menu item to `file:utils/sidebarConfig.ts` under Sales → Transactions
...
- [ ] "Product Promotions" appears in sidebar under Sales → Transactions
...
- [ ] Navigation works with both expanded and collapsed sidebar

## Technical References

- **Tech Plan**: `spec:187d664a-8b1f-483b-a606-15fe734b049f/5fd7de40-a5b7-4c37-ae0f-5420b0b52d57` (Integration section)
- **Pattern Reference**: `file:utils/sidebarConfig.ts`, `file:App.tsx`, `file:constants.ts`
