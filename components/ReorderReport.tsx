...
import { Printer, Loader2, AlertTriangle, CheckCircle, Package } from 'lucide-react';
                ...
                reportEntries.map((entry) => {
                  ...
                  return (
                    <tr key={entry.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors print:hover:bg-transparent">
                      ...
                      <td className="p-4 align-top text-center print:p-2">
                        <span
                          className={`inline-flex items-center gap-1 px-2 py-1 rounded text-[10px] font-bold uppercase border print:border-black print:bg-transparent print:text-black ${
                            isCritical
